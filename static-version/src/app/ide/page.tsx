  ...
  return (
    <div className="">
      ...
      <p className="text-lg leading-relaxed text-gray-300 mb-6">
        An engineer with a strong foundation in software engineering and
        development including 1 year of hands on experience in the industry. A
        proactive results-driven problem solver dedicated to productivity and
      ...
      <blockquote className="text-xl italic text-gray-400 border-l-4 border-blue-500 pl-4 mb-6">
        &quot;I have been passionate about computers since I played my first
        video game, Need For Speed 2, at the age of four. Exploring both
        hardware and software during my childhood fueled my passion for Computer
        Science. Now, I aim to apply the learned theoretical and practical
        concepts to real-world problems and create innovative, passionate
        projects.&quot;
      </blockquote>
