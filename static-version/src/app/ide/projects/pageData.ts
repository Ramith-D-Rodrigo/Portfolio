...
const projects = [
  {
    title: "Real-time 3D Point Cloud Reconstruction using WebXR",
    description:
      "A small project in where I experiemented and used WebXR's depth-sensing API to measure the distance between the user camera and real life objects to generate the 3D point-cloud of the real world." +
      " I also used web workers to offload heavy computations and enabled parallel processing of depth data. After generating the point cloud, I also added a feature to export it as a GLTF model file.",
    techStack: [GIT, TS, WEBXR, WEBGL, THREEJS],
    timePeriod: "2025 April - 2025 April",
    isExternalLink: true,
    link: "https://github.com/Ramith-D-Rodrigo/webxr-point-cloud",
    linkContent: "GitHub",
    linkDisabled: false,
  },
  {
    title:
      "Enhancing the performance of web-based Extended Reality applications",
    description:
      "The final year research project of my Bachelor's degree. I conducted this research to improve the runtime" +
      ...
      " suitable quantitative and qualitative metrics. According to the experiement results, I was able to achieve stable performance in WebGPU + WebAssembly implementation across multiple devices. " +
      "However, due to the limited official support of WebXR + WebGPU in the time period I conducted this research, I was not able to achieve the same level of performance as the native implementation. " +
      "Interested individuals can further enhance this since the official WebXR + WebGPU support is now available in Google Chrome.",
    techStack: [CPP, WEBGL, WEBGPU, WASM, GIT, TS, WEBXR],
    timePeriod: "2024 June - 2025 April",
    isExternalLink: true,
    link: "https://github.com/Ramith-D-Rodrigo/Webxr-WebGPU-Wasm",
    linkContent: "GitHub",
    linkDisabled: false,
  },
  {
    title: "Portfolio",
    description:
      "To showcase my skills, education, experience and projects, I have developed a simple website" +
  ...
  },
  {
    ...
    description:
      "I developed a procedural open world as part of my Bachelor's degree, applying concepts learned in my Computer Graphics II course." +
  ...
  },
  {
    ...
    description:
      "To learn Unreal Engine and C++ in game development, I am building a 3D simple video game." +
  ...
  {
    title:
      "Implement CLI command 'bal test --cloud=docker' to run Ballerina tests in Docker containers",
    description:
      "During my internship with WSO2 LLC's Ballerina Team, I was tasked with implementing a feature to run all tests of a Ballerina project in Docker containers. " +
  ...
  },
  {
    title: "?D - Video Game",
    description:
      "As a part of the Game Development course of my Bachelor's degree, I developed a 3D video game using Unity Engine. It is a game based on 3 axes of the 3D world." +
  ...
  },
  {
    title: "Solar System",
    description:
      "I developed a 3D scene of the solar system using Three.js for the Game Development course of my Bachelor's degree." +
  ...
  },
  {
    ...
    description:
      "During the first semester of my third academic year, I led a group to build a web-based application to streamline the review process of " +
  ...
  },
  {
    ...
    description:
      "I developed a simple web application to understand the algorithms and steps behind the CFG simplication. " +
  ...
  },
  {
    ...
    description:
      "I led a group of 4 members to develop a web-based application for my second year group project. " +
  ...
  },
  {
    ...
    description:
      "I developed a simple web server in Java to understand how client-server request-response communication works.",
