...
import InteractableArea from "./interactable";
...
const setupGymEquipment = async (scene: THREE.Scene, world: CANNON.World, loader: GLTFLoader) => {
    ...
    const interactable = new InteractableArea(-9, 0, -4, 0, 0, 0, 5);
    interactable.addToWorld(world);
    ...
    // add the interactable collision area
    const interactable2 = new InteractableArea(7, 1, 5, 0, 0, 0, 3);
    interactable2.addToWorld(world);
    ...
    // add the interactable collision area
    const interactable3 = new InteractableArea(-9, 1.5, 5, 0, 0, 0, 3.5);
    interactable3.addToWorld(world);
...
const setupRoom = async (scene: THREE.Scene, world: CANNON.World, loader: GLTFLoader, textureLoader: THREE.TextureLoader) => {
    ...
    // add the interactable collision area
    const interactable = new InteractableArea(0, 0, 0, 0, 0, 0, 2);
    interactable.addToWorld(world);
}
